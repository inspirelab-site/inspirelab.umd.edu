...
{% include list.html component="card" data="codes" filter="group == 'dynamics'" %}

<a name="section-2"></a>

### fMRI Brain Data (pre-)Processing Toolbox
{% include list.html component="card" data="codes" filter="group == 'preprocessing'" %}

<a name="section-3"></a>

### Scientific Computing Tools
{% include list.html component="card" data="codes" filter="group == 'scientific-comp'" %}